        ...
        try {
            ...
            esteh: 0,
                ...
                if (chat) {
                    ...
                    if (!('autoSalam' in chat)) chat.autoSalam = false
            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                        this.reply(m.chat, `Limit anda habis, silahkan beli melalui *${usedPrefix}buy* atau *${usedPrefix}ownerganteng untuk mendapatkan bonus dari owner*`, m)
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        unreg: 'Hai kak, tolong registrasi terlebih dahulu sebelum menggunakan bot!\n\n▢ *_Manual regist_*\n*Example:* .daftar bluxsxx.19\n▢ *_Email regist_*\n*Example:* .regmail bluxsxx@gmail.com\n\n*NOTE:* Register dengan email akan mendapatkan antara 100 - 200 limit.',
